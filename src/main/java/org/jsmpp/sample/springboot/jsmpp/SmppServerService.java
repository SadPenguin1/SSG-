...
public class SmppServerService {
  ...
  public void start() {
    ...
    try {
      ...
      // set ProseccorDegree 
      sessionListener.setPduProcessorDegree(10);
      ...
      log.error("Could not listen on port dong 90" + port, e);
    }
    log.info("SMPP server stopped dong 92");
  }
  ...
  public void stop() {
    try {
      ...
      log.info("SMPP service stopped dong 101");
    } catch (final IOException e) {
      log.error("Could not stop listener dong 103", e);
    }
  }
